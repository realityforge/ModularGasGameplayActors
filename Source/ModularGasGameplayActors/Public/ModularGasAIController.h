...
class AModularGasAIController : public AModularAIController, public IAbilitySystemInterface
{
    GENERATED_BODY()
...
public:
    UE_API explicit AModularGasAIController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
